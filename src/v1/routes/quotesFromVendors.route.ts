...
import { addQuotesFromVendors, getAllQuotesFromVendors, getQuotesFromVendorsById,deleteQuotesFromVendorsById, updateQuotesFromVendorsById } from '../controllers/quotesFromVendors.controller';
